...
& java -jar swagger-codegen-cli-2.4.5.jar generate -i https://api.cloudmersive.com/swagger/api/barcode -l csharp -o client -c packageconfig.json
...
(Get-Content '.\client\src\Cloudmersive.APIClient.NET.Barcode\Client\ApiClient.cs').replace('request.AddFile(param.Value.Name, param.Value.Writer, param.Value.FileName, param.Value.ContentType);', 'request.AddFile(param.Value.Name, param.Value.Writer, param.Value.FileName, param.Value.ContentLength, param.Value.ContentType);') | Set-Content '.\client\src\Cloudmersive.APIClient.NET.Barcode\Client\ApiClient.cs'
...
& C:\CodeSigning\sign.ps1 ./client/src/Cloudmersive.ApiClient.NET.Barcode/bin/Debug/Cloudmersive.APIClient.NET.Barcode.dll

./nuget.exe pack $csprojpath

(Get-Content ./client/README.md).replace(' automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project', " for the [Cloudmersive Barcode API](https://www.cloudmersive.com/barcode-api)") | Set-Content ./client/README.md
