...
namespace Cloudmersive.APIClient.NET.Barcode.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class BarcodeAdvancedScanResult :  IEquatable<BarcodeAdvancedScanResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BarcodeAdvancedScanResult" /> class.
        /// </summary>
        /// <param name="successful">True if the operation was successful, false otherwise.</param>
        /// <param name="resultBarcodes">Results of performing the barcode scan operation.</param>
        /// <param name="barcodeCount">Number of barcodes read.</param>
        /// <param name="errorMessage">Error message if any.</param>
        public BarcodeAdvancedScanResult(bool? successful = default(bool?), List<BarcodeAdvancedResultItem> resultBarcodes = default(List<BarcodeAdvancedResultItem>), int? barcodeCount = default(int?), string errorMessage = default(string))
        {
        ...
        /// </summary>
        /// <value>Results of performing the barcode scan operation</value>
        [DataMember(Name="ResultBarcodes", EmitDefaultValue=false)]
        public List<BarcodeAdvancedResultItem> ResultBarcodes { get; set; }
        ...
        {
            return this.Equals(input as BarcodeAdvancedScanResult);
        }

        /// <summary>
        /// Returns true if BarcodeAdvancedScanResult instances are equal
        /// </summary>
        /// <param name="input">Instance of BarcodeAdvancedScanResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BarcodeAdvancedScanResult input)
        {
            if (input == null)
                return false;
